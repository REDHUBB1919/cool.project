  ...
  (
    ...
    useEffect(() => {
      if (active && payload?.length) {
        ...
        if (indicatorColor) {
          document.documentElement.style.setProperty('--color-bg', indicatorColor);
          document.documentElement.style.setProperty('--color-border', indicatorColor);
        }
      }
    ...
    useEffect(() => {
      if (payload?.length) {
        payload.forEach((item) => {
          if (item.color) {
            document.documentElement.style.setProperty('--indicator-color', item.color);
          }
        });
      }
    }, [payload]);
